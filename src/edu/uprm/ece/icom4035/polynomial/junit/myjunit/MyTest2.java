 ...
 *
 */
public class MyTest2 extends Debug {
	...
	public void testAddObject() {
		...
		assertTrue(list.toString().equals("SinglyLinkedList [size=3; data=[1, 2, 3]]"));
	}
	...
	public void testAddIndex() {
		...
		String expected = "SinglyLinkedList [size=4; data=[1, 4, 3, 2]]";
	...
	public void testRemove() {
		...
		assertTrue(list.toString().equals("SinglyLinkedList [size=3; data=[1, 2, 4]]"));
	}
	...
	public void testAddClear() {
		...
		String expected = "SinglyLinkedList [size=0; data=[]]";
	...
	public void testAddContains() {
		...
		print("\tActual After remove index=2 #2: " + list);
